import { computed, unref, createVNode, resolveDynamicComponent, h, useSSRContext } from 'file:///Users/nihasnizar/Downloads/ONE/ghpage/thinktribe/node_modules/vue/index.mjs';
import { ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderVNode } from 'file:///Users/nihasnizar/Downloads/ONE/ghpage/thinktribe/node_modules/vue/server-renderer/index.mjs';
...
const description = "UGC NET aspirants! This webinar is designed to equip you with the strategies and insights needed to excel in your upcoming exams. Join expert educator Aysha Hamna P for an exclusive session that will cover essential tips, resources, and a roadmap to success.";
const _sfc_main = {
  __name: "conquer-the-net-strategy-session",
  __ssrInlineRender: true,
  setup(__props) {
    const baseURL = useRuntimeConfig().app.baseURL;
    const bannerImage = `${baseURL}/images/webinar2.jpg`;
    const speaker = {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/webinar/conquer-the-net-strategy-session.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=conquer-the-net-strategy-session-CoJrXOVB.mjs.map
