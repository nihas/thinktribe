...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/destr/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/unstorage/dist/index.mjs';
...
import consola, { consola as consola$1 } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/nihasnizar/Downloads/ONE/thinktribe/node_modules/vue/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/nihasnizar/Downloads/ONE/thinktribe/.data/kv"}));
...
const _VJXASJiGXzec5Mc6FeV4oCywCclSQOYvABAL2etK08 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/nihasnizar/Downloads/ONE/thinktribe";
...
const _toAibQ5uOKnM4ubZ5ONdz4dyoHUhY0t2XGZLy4aDtiU = (nitroApp) => {
...
const plugins = [
  _VJXASJiGXzec5Mc6FeV4oCywCclSQOYvABAL2etK08,
_toAibQ5uOKnM4ubZ5ONdz4dyoHUhY0t2XGZLy4aDtiU
];
...
const getServerEntry = () => import('file:///Users/nihasnizar/Downloads/ONE/thinktribe/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/nihasnizar/Downloads/ONE/thinktribe/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_FJsNok = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_FJsNok, lazy: true, middleware: false, method: undefined },
