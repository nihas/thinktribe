...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-B4AiWYQW.js")
  },
  {
    name: "teams",
    path: "/teams",
  ...
  },
  {
    name: "about-us",
    path: "/about-us",
    component: () => import("./_nuxt/about-us-BE9p1Px6.js")
  },
  {
    name: "webinar-EventDetails",
    path: "/webinar/EventDetails",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/roadmap-to-publishing-social-science-G67CHQK7.js")
  }
];
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative inline-block group" }, _attrs))}><span class="absolute -bottom-1 -right-1 w-full h-full border-2 border-black rounded-full transition-all group-hover:translate-x-0.5 group-hover:translate-y-0.5"></span><button class="relative z-10 bg-black text-white px-6 py-2 rounded-full font-medium hover:bg-gray-900 active:scale-95 transition transform">${ssrInterpolate(__props.label)}</button></div>`);
    };
  }
});
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><button class="md:hidden text-green-800">`);
      if (!isOpen.value) {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-41fea99d>`);
      _push(ssrRenderComponent(_sfc_main$3, { class: "fixed top-0 left-0 right-0 z-50" }, null, _parent));
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-41fea99d"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CHdzcnnw.js"));
